...
export const bibleVersesByTheme: Record<Theme, string[]> = {
  ...
  Leadership: [
    ...
    "Deuteronomy 17:18-20 - When he takes the throne of his kingdom, he is to write for himself on a scroll a copy of this law, taken from that of the Levitical priests. It is to be with him, and he is to read it all the days of his life so that he may learn to revere the Lord his God and follow carefully all the words of this law and these decrees and not consider himself better than his fellow Israelians and turn from the law to the right or to the left. Then he and his descendants will reign a long time in his kingdom in Israel.",
...
/**
 * Get random verses from a theme
 * @param theme - The theme to select verses from
 * @param count - Number of verses to return (default: 2)
 * @returns Array of randomly selected Bible verses
 */
export function getRandomVerses(theme: Theme, count: number = 2): string[] {
